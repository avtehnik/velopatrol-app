...
public class SignUpTask extends BaseTaskMaterial {
	...
	public SignUpTask(String name, String phone, String password, Context context) {
		super(context, true);
		this.name = name;
		this.phone = phone;
	...
	protected Boolean doInBackground(String... params) {
		try {
			...
			HttpResponse response = RequestUtils.postHttpResponse(SystemUtils.SIGN_UP_URL, nameValuePairs);
